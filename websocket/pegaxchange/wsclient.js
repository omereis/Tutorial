 ...
 */
function alert_missing_param (element_id, func) {
...
function onConnectClick() {
    ...
    if (ws_hostname.length == 0) {
        alert_missing_param ("hostname", "host") 
    }
    else if  (ws_port.length == 0) {
        alert_missing_param ("port", "port") 
    }
    else if  (ws_port.length == 0) {
        alert_missing_param ("endpoint", "End Point") 
    }
    else
