...
def insert_result (token, job_id, zip_file_name):
    try:
        ...
        cursor.close()
        conn.close()
        print("Token '%s', Job ID %d, end time updated" % (str(token), job_id))
...
#    select_author(12)
    ...
    update_blob(2, "d:\\Omer\\Source\\Tutorial\\MySQL\\ccd03d_11.zip")
    insert_result ('ccd03d', 11, "d:\\Omer\\Source\\Tutorial\\MySQL\\ccd03d_11.zip")
