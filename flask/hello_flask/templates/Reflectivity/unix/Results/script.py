...
## === Data files ===
probe = load4('10ndt001.refl', back_reflectivity=False)
#probe = Probe(T=numpy.linspace(0.12539, 4.1070, 251), L=5.0000)
...
sld1 = SLD(name='sld1', rho=3.0000, irho=0.0000)
sld2 = SLD(name='sld2', rho=4.0000, irho=0.0000)
sld3 = SLD(name='sld3', rho=5.0000, irho=0.0000)
...
layer0 = Slab(material=sld0, thickness=0.0000, interface=9.0000)
layer1 = Slab(material=sld1, thickness=1250.0, interface=10.000)
layer2 = Slab(material=sld2, thickness=1500.0, interface=11.000)
layer3 = Slab(material=sld3, thickness=2000.0, interface=12.000)
...
sld1.rho.range(2.0000, 4.0000)
sld2.rho.range(3.0000, 5.0000)
sld3.rho.range(4.0000, 6.0000)
...
layer2.thickness.range(1400.0, 1600.0)
layer3.thickness.range(1900.0, 2100.0)
...
###################################################################
layer0.interface.range(0.0000, 19.000)
layer1.interface.range(0.0000, 20.000)
layer2.interface.range(1.0000, 21.000)
layer3.interface.range(2.0000, 22.000)
