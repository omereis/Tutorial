...
def hello():
    ...
    html =  "<title>Docker App</title>" \
            ...
            "<td align=\"right\" style=\"background-color:powderblue;\"><b>Host Name</b></td><td> {hostname}</td>" \
            "</tr><tr>" \
            "<td align=\"right\" style=\"background-color:rgb(156, 198, 204);\"><b>IP</b><td> {ip}</td></td>" \
            "</tr><tr>" \
            "<td align=\"right\"><b>Visits</b></td><td style=\"background-color:yellow;\"> {visits}</td>" \
            "</tr>" \
            "<td align=\"right\"><b>Time</b></td><td> {current_time}</td>" \
            "</tr><tr>" \
            "<td align=\"right\"><b>Version</b></td><td> {python_version}</td>" \
            "</tr><tr>" \
            "<td align=\"right\"><b>str(Redis)</b></td><td> {redisStr}</td>" \
            "</tr></table>" \
